...
SUMMARY_PROMPT = (
    ...
    "\"body\": a substantive paragraph of 4-6 sentences covering all four dimensions: "
    "(1) WHAT happened — name the specific actors, institutions, sums, and decisions involved; "
    "(2) WHY — what problem, pressure, or strategic objective is driving this; "
    "(3) HOW — the mechanism, scope, timeline, or implementation detail; "
    "(4) IMPACT — the direct consequences, who is affected, and what changes as a result. "
    "Where a specific law, strategy document, framework, fund, or programme is described, name it explicitly. "
    "Avoid vague filler phrases such as 'represents a significant step', 'aims to improve', or "
    "'highlights the importance of' — every sentence must add concrete information.\n"
    "\"strategic_note\": 2-3 sentences answering the question: why should someone working in UK government "
    "AI take note of this? Focus on the practical significance — whether this development is good or bad "
    "for the UK government's AI agenda and why; what risk, opportunity, or precedent it sets; what it "
    "signals about the direction of travel in AI governance or deployment that the UK will need to respond "
    "to; or what a UK practitioner should do differently or be aware of as a result. "
    "Do not name specific UK government departments, bodies, or frameworks — they change frequently. "
    "Be direct and specific about the implication: avoid 'the UK should monitor this' or "
    "'this is relevant to UK AI policy' without explaining precisely what the relevance or implication is.\n"
