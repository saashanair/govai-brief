...
SUMMARY_PROMPT = (
    ...
    "\"strategic_note\": 2-3 sentences of specific, substantive analysis for a UK government AI practitioner. "
    "Cover at least one of: how this compares with the UK's current approach or equivalent initiative "
    "(name the relevant UK institution, policy, or framework explicitly); what regulatory alignment or "
    "divergence it signals between the UK and the described jurisdiction; what a specific UK department, "
    "regulator, or minister should consider or act on; or what concrete competitive, procurement, or "
    "capability implication this has for the UK public sector. "
    "Avoid generic observations such as 'the UK should monitor this', 'this is relevant to UK AI policy', "
    "or 'this offers lessons for the UK' without specifying what those lessons are and for whom.\n"
